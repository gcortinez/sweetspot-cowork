    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.jsdelivr.net https://*.clerk.accounts.dev https://clerk.sweetconnect.com https://clerk.cowork.thesweetspot.cloud https://www.google.com https://www.gstatic.com https://js.stripe.com https://challenges.cloudflare.com https://*.hcaptcha.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.clerk.accounts.dev https://clerk.sweetconnect.com https://clerk.cowork.thesweetspot.cloud https://*.hcaptcha.com",
              "font-src 'self' https://fonts.gstatic.com https://*.clerk.accounts.dev https://clerk.sweetconnect.com https://clerk.cowork.thesweetspot.cloud",
              "img-src 'self' data: https: blob:",
              "connect-src 'self' https: https://*.clerk.accounts.dev https://clerk.sweetconnect.com https://clerk.cowork.thesweetspot.cloud https://www.google.com https://challenges.cloudflare.com https://*.hcaptcha.com",
              "worker-src 'self' blob:",
              "frame-src 'self' https://www.google.com https://challenges.cloudflare.com https://*.hcaptcha.com https://*.clerk.accounts.dev",
