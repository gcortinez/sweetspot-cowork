    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.jsdelivr.net https://*.clerk.accounts.dev https://clerk.sweetconnect.com https://clerk.cowork.thesweetspot.cloud",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.clerk.accounts.dev https://clerk.sweetconnect.com https://clerk.cowork.thesweetspot.cloud",
              ...
              "connect-src 'self' https: https://*.clerk.accounts.dev https://clerk.sweetconnect.com https://clerk.cowork.thesweetspot.cloud",
