    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://cdn.jsdelivr.net https://*.clerk.accounts.dev https://clerk.sweetconnect.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://*.clerk.accounts.dev https://clerk.sweetconnect.com",
              "font-src 'self' https://fonts.gstatic.com https://*.clerk.accounts.dev https://clerk.sweetconnect.com",
              "img-src 'self' data: https: blob:",
              "connect-src 'self' https: https://*.clerk.accounts.dev https://clerk.sweetconnect.com",
