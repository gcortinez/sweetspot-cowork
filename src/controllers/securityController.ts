 ...
 */
export const invalidateSession = async (req: AuthenticatedRequest, res: Response) => {
  try {
 ...
 */
export const invalidateAllOtherSessions = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const userId = req.user!.id;
 ...
 */
export const updateSessionConfig = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    if (error instanceof z.ZodError) {
      return ResponseHelper.badRequest(res, 'Invalid session configuration', error.errors);
    }
    ...
    return ResponseHelper.internalError(res, 'Failed to update session configuration');
  }
};
 ...
 */
export const addToIPWhitelist = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    if (error instanceof z.ZodError) {
      return ResponseHelper.badRequest(res, 'Invalid IP whitelist data', error.errors);
    }
 ...
 */
export const removeFromIPWhitelist = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    return ResponseHelper.internalError(res, 'Failed to remove IP from whitelist');
  }
};
 ...
 */
export const checkIPWhitelist = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { ipAddress } = req.params;
    const tenantId = req.user!.tenantId;
...
export const getSecurityEvents = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const tenantId = req.user!.tenantId;
    const events = await securityEventService.getSecurityEvents(tenantId, query);

    return ResponseHelper.success(res, events);
  } catch (error) {
    if (error instanceof z.ZodError) {
      return ResponseHelper.badRequest(res, 'Invalid query parameters', error.errors);
    }
    ...
    return ResponseHelper.internalError(res, 'Failed to retrieve security events');
  }
};
 ...
 */
export const getSecurityEventStats = async (req: AuthenticatedRequest, res: Response) => {
  try {
    const tenantId = req.user!.tenantId;
    const timeframe = req.query.timeframe as string || '7d';

    const stats = await securityEventService.getSecurityEventStatistics(tenantId, timeframe);
    ...
    return ResponseHelper.internalError(res, 'Failed to retrieve security statistics');
  }
};
...
export const resolveSecurityEvent = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    await securityEventService.resolveSecurityEvent(eventId, userId, resolution, notes);
    ...
    return ResponseHelper.internalError(res, 'Failed to resolve security event');
  }
};
...
export const getAuditLogs = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const tenantId = req.user!.tenantId;
    const logs = await auditLogService.getAuditLogs(tenantId, {
      page,
      limit,
      userId,
      action,
...
export const exportAuditLogs = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const exportData = await auditLogService.exportAuditLogs(tenantId, {
      format,
      startDate: startDate ? new Date(startDate) : undefined,
      endDate: endDate ? new Date(endDate) : undefined
    });
 ...
 */
export const generateEncryptionKey = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    return ResponseHelper.internalError(res, 'Failed to generate encryption key');
  }
};
 ...
 */
export const testEncryption = async (req: AuthenticatedRequest, res: Response) => {
  try {
...
export const getSecurityDashboard = async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const [
      ...
      securityEventService.getSecurityEventStatistics(tenantId, timeframe),
      securityEventService.getRecentSecurityEvents(tenantId, 10),
      sessionService.getUserActiveSessions(req.user!.id),
      auditLogService.getAuditLogStatistics(tenantId, timeframe)
    ]);
    ...
    return ResponseHelper.internalError(res, 'Failed to retrieve security dashboard data');
  }
};