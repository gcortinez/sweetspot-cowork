      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.clientSection}>
          ...
          <View style={styles.clientInfo}>
            ...
            {quotation.client.contactPerson && (
              <Text style={styles.clientDetail}>Contacto: {quotation.client.contactPerson}</Text>
            )}
          </View>
        </View>
        ...
        <View style={styles.termsSection}>
          ...
          <Text style={styles.termsText}>
            ...
            • Para confirmar los servicios, es necesario firmar el contrato correspondiente
          </Text>
        </View>
        ...
        {quotation.notes && (
          <View style={styles.notesSection}>
            <Text style={styles.notesTitle}>Notas Internas</Text>
